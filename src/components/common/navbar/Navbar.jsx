                    ...
                    <Box sx={{ display: "flex", alignItems: "center", width: "100%", justifyContent: "space-between" }}>
                        ...
                        {!isMobile && (
                            <Box sx={{ display: "flex", alignItems: "center", gap: "4px" }}>
                                ...
                                {authenticated && <NavLink to="/find-booking">Foglalásaim</NavLink>}
                                {admin && <NavLink to="/admin">Admin</NavLink>}
                                {!authenticated && <NavLink to="/login">Bejelentkezés</NavLink>}
                                {!authenticated && (
                                    <NavLink to="/register" style={{ backgroundColor: "#2563eb", color: "#fff", padding: "8px 16px", borderRadius: "8px", marginLeft: "8px", fontWeight: 600 }}>
                                        Regisztráció
                                    </NavLink>
                                )}
                                {authenticated && (
                        ...
                        {isMobile && (
                            <IconButton onClick={toggleDrawer(true)} size="large" edge="end" aria-label="menu">
                                <MenuIcon />
                            </IconButton>
                        )}
                    </Box>
                    ...
                    {authenticated && !isMobile && (
                            ...
                            slotProps={{
                                paper: {
                                    ...
                                    sx: {
                                        ...
                                        "& .MuiDivider-root": { margin: "4px 0", borderColor: "#e0e7ff" },
                                        "&::before": {
                                            content: '""',
                                            display: "block",
                                            position: "absolute",
                        ...
                        >
                            <MenuItem
                                ...
                                sx={{ fontSize: "0.9rem", fontWeight: 500, color: "#374151", padding: "10px 16px", borderRadius: "8px", margin: "4px 8px", display: "flex", alignItems: "center", gap: "10px", "&:hover": { backgroundColor: "#eff6ff", color: "#2563eb" } }}
                            >
                            ...
                            <MenuItem
                                ...
                                sx={{ fontSize: "0.9rem", fontWeight: 500, color: "#dc2626", padding: "10px 16px", borderRadius: "8px", margin: "4px 8px", "&:hover": { backgroundColor: "#fef2f2", color: "#b91c1c" } }}
                            >
                            ...
                            <List>
                                {navLinks.map((link) => (
                                    <ListItem key={link.to} disablePadding>
                                        <ListItemButton component={NavLink} to={link.to} onClick={toggleDrawer(false)}>
                                ...
                                {authenticated && (
                                    <>
                                        ...
                                        <ListItem disablePadding>
                                            <ListItemButton onClick={() => { toggleDrawer(false)(); handleLogout(); }}>
